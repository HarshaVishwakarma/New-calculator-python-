...
class Window:
    ...
    def __init__(self):
        ...
        self.txtbox1 = Entry(master=self.win, font=('consolas', 18, 'bold'))
        ...
        self.add = Button(master=self.win, text="+",
                           font=('consolas', 18, 'bold'),command=self.Add)
        ...
        self.clear.place(x=20, y=170, width=640, height=30)
